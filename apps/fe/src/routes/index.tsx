			...
			<div className="container mx-auto px-6 py-12">
				<div className="text-center mb-12">
					...
					<p className="text-xl text-gray-300 mb-8">
						A modern React application with authentication powered by Better
						Auth and TanStack Router
					</p>
				...
				<div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
					<Card className="bg-gray-800 border-gray-700 text-white">
						...
						<CardContent>
							<p className="text-sm text-gray-400">
								Industry-standard security with session management and protected
								routes.
							</p>
						</CardContent>
					</Card>
					...
					<Card className="bg-gray-800 border-gray-700 text-white">
						...
						<CardContent>
							<p className="text-sm text-gray-400">
								File-based routing with built-in authentication guards and
								redirects.
							</p>
						</CardContent>
					</Card>
