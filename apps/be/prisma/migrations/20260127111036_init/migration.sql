...
-- CreateIndex
CREATE UNIQUE INDEX "assest_userId_stockId_key" ON "assest"("userId", "stockId");
...
-- AddForeignKey
ALTER TABLE "assest" ADD CONSTRAINT "assest_stockId_fkey" FOREIGN KEY ("stockId") REFERENCES "stock"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
